...
class EditCafePage extends StatefulWidget {
  ...
  const EditCafePage({super.key, required this.place});

  @override
  State<EditCafePage> createState() => _EditCafePageState();
}
...
class _EditCafePageState extends State<EditCafePage> {
  ...
  Future<void> submit() async {
    ...
    if (result) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Cafe berhasil diperbarui")));
    } else {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Gagal mengedit cafe")));
    }
  }
  ...
  Widget build(BuildContext context) {
    // ⬅️ penting: transparan, biar bg dari route (barrierColor) yang dipakai
    return Scaffold(
            ...
            child: ConstrainedBox(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: const Color(0xFFFFE4D8), // warna card peach
